...
In this section the conceptual framework developed so far—memetic replication, interpretation, archetypes, and historical dynamics—is synthesised into a formal model. The goal is to describe how ideas change, interact, and evolve, and to evaluate whether these dynamics justify describing ideas as “alive.”
...
* **recurrence** (how often a meme appears) \- used to identify potential thoughtforms  
* **adjacency** (which memes co‑occur) \- used to describe relationships between memes and to detect higher‑order structures
...
* Strong attractors: Occur frequently and recur over short distances  
* Weak attractors: Occur infrequently or recur over long distances
...
2. If the anchoring thoughtform of E1 is not a member of E2(and vice versa)

   interpretation fails; the sets remain distinct.

## 3.4 Meiosis

This framework brings us back to the biological analogy. Just as genes recombine during meiosis to produce novel configurations, memetic structures can recombine when egregores interact. This recombination produces new idea‑complexes, further supporting the analogy between ideas and living systems.
