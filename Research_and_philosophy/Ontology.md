...
## Tulpamancy  
### What is tulpamancy and how does it reverse the paradigm?  
...
From these practices we can acquire a memetic structure of Tulpamancy similar to how we acquired a memetic structure of YouTube in previous research. Noticeably a common theme amongst these practices is the use of high levels of focus onto a specific set of stimulation in a given field. In terms of memes and ideas when you are focusing on a specific piece of stimulation you are allowing the idea of that stimulation to reproduce in your mind effectively making the idea into a thoughtform temporarily by relaxing the selectivity of the environment in which ideas propagate unlike YouTube which amplifies this selectivity using engagement metrics. This key difference could explain why Tulpamancers seem to have high levels of social chaos whereas YouTube seems to decrease users social chaos. 

This tells us that if we want Datacentral to make it easier for users to extract ideas from data then Datacentral should create an environment in which users focus on these ideas, perhaps by engaging the senses of the user.
