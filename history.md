...
After rebuilding datacentral it became grounded in a base level of operation. Once this occured and the system as a whole was at a point where it was usable I wrote a specification file for my add ons which was something I always intended to do. The specification file means that anyone can create the same add on as long as it follows the specification and it will integrate into the datacentral ecosystem exactly the same. I identified two types of objects in my specification: Add-ons and extensions. Extensions are external projects that I integrated into the source code - these interact with add ons but not with the user directly. I then decided to work backwards from these two types of object to start working on research papers such that add ons and extensions are a direct implementation of this datacentral philosophy. I started considering the datacentral philosophy as I was creating datacentral over time however this was my first time formalising it. I plan to integrate this research paper with a research paper I have written in the past on how technological algorithms effect the creation of culture as a kind of antithesis to this - how should an algorithm be architectured to promote the healthy formation of culture and allow users to interact with ideas more deeply. This achitecture philosophy will then allow me to expand my specification and create a better datacentral. 
