...
As a prerequisite it requires:
A place to store the text files
A text editor

Implementation:
Following the method of extracting egregores from text from text A I will recommend texts using the strength between egregores in those texts as a ranking system 

# What is the point of the tagger?
Ideally I want the tagger to be a part of a system I call the “simulatrix” - it can take any kind of interface such as a text file or video and you can interact with that file through a side-interface for example asking questions about a video. It should also be able to work in reverse where you create media through this side interface. I want this to act as a research assistant in the future and hopefully create the path to a computational approach to physics. 
